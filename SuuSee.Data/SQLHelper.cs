...
namespace SuuSee.Data
{
    public   static class SqlHelper
    {
        ...
        public static readonly string connectionString = System.Web.Configuration.WebConfigurationManager.ConnectionStrings[0].ToString().Trim();
        ...
        /// <param name="commandParameters">以数组形式提供SqlCommand命令中用到的参数列表</param>
        /// <returns>返回一个数值表示此SqlCommand命令执行后影响的行数</returns>
        public static int ExecteNonQueryStoredProcedure(string cmdText, params SqlParameter[] commandParameters)
        {
        ...
        /// <param name="commandParameters">以数组形式提供SqlCommand命令中用到的参数列表</param>
        /// <returns>返回一个表集合(DataTableCollection)表示查询得到的数据集</returns>
        public static DataTableCollection GetTableStoredProcedure(string cmdText, SqlParameter[] commandParameters)
        {
        ...
        public static SqlDataReader ExecuteReaderStoredProcedure(  string cmdText, params SqlParameter[] commandParameters)
        {
        ...
        /// <param name="commandParameters">以数组形式提供SqlCommand命令中用到的参数列表</param>
        /// <returns>return a dataset</returns>
        public static DataSet ExecuteDataSetStoredProcedure(string cmdText, params SqlParameter[] commandParameters)
        {
        ...
        /// <param name="commandParameters">以数组形式提供SqlCommand命令中用到的参数列表</param>
        /// <returns>返回一个对象</returns>
        public static object ExecuteScalarStoredProcedure(string cmdText, params SqlParameter[] commandParameters)
        {
